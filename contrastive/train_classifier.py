...
def load_and_format_embeddings(dir_path, labels_path):
    ...
    print("embeddings:", embeddings.iloc[:10,:])
...
def train_classifier(config):
    ...
    X,Y,n_train,n_val,_ = load_and_format_embeddings(train_embs_path, train_lab_paths)
