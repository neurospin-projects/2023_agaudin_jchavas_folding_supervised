...
embeddings_pipeline("/volatile/jc225751/Runs/59_analysis_ukbiobank/Output/trained_on_ukbiobank/chosen_model/",
dataset='cingulate_HCP_full_Flanker_AgeAdj', verbose=True, classifier_name='svm', overwrite=True)