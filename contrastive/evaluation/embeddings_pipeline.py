...
embeddings_pipeline("/neurospin/dico/data/deep_folding/papers/ipmi2023/models/contrastive/trained_on_test_ACCpatterns",
dataset='test_cingulate_ACCpatterns', verbose=True, classifier_name='svm', overwrite=False)
