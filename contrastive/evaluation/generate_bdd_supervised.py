...
folders = ["/volatile2/jc225751/Runs/61_classifier_regresser/Program/Output/2023-08-29_extreme_flanker_end_criterion/"]
bdd = []
visited = []
...
# save the database
name = "2023-08-29_extreme_flanker_end_criterion"
