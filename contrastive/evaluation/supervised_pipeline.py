...
pipeline("/volatile2/jc225751/Runs/61_classifier_regresser/Program/Output/2023-09-01_no_earlystopping",
         datasets=["cingulate_HCP_stratified_extreme_Flanker_shuffled_left",
                   "cingulate_HCP_stratified_extreme_Flanker_shuffled_right"],
         label='Flanker_AgeAdj_class',
         short_name='flanker_class_shuffled', overwrite=True, use_best_model=True)
